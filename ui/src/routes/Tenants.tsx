    ...
    <div className="sheet">
      ...
      <div className="body stack">
        ...
        <p className="prose prose--lead">
          Each customer’s data is stored and accessed separately. Open one to grant, scope
          or withdraw access to their accounts.
        </p>
        ...
        >
          <div className="field" style={{ maxWidth: "24rem" }}>
            ...
            <span id="tenant-name-hint" className="field__hint">
              Use the case reference, not the company’s real name. Real names are held only
