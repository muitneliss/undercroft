...
*are* the conversation — and a tool's result is replaced by a one-line summary the tool itself
...
model cannot read the Wheel Rule. The closed plate case gives better output *and* no
vulnerability.
