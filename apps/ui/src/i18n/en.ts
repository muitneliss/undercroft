...
export const en = {
  ...
  landing: {
    ...
    userPathLabel: "Your path",
    stepInviteTitle: "Invited",
    stepInviteBody: "An admin invites you by email.",
    stepConnectTitle: "Connect",
    stepConnectBody: "Gmail, Google Drive, HubSpot or Xero.",
    stepChooseTitle: "Choose scope",
    stepChooseBody: "You choose what may be read.",
    stepRunTitle: "Run",
    stepRunBody: "Every run records what landed, what was refused and why.",
    stepModelTitle: "Model",
  ...
  lake: {
    ...
    alsoBytesRead_one:
      "{{bytes}} in {{count, number}} distinct file · {{readable, number}}/{{total, number}} readable · {{refused, number}} refused · {{waiting, number}} not read yet",
    alsoBytesRead_other:
      "{{bytes}} in {{count, number}} distinct files · {{readable, number}}/{{total, number}} readable · {{refused, number}} refused · {{waiting, number}} not read yet",
    refusalsOpen: "See why they were refused",
