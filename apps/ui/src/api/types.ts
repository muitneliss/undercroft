...
/** One app a person let in through the OAuth flow, as `account.apps.list` returns it. */
export type ConnectedApp = inferRouterOutputs<AppRouter>["account"]["apps"]["list"][number];
