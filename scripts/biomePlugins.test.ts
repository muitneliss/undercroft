...
// biome-ignore-all lint/style/noMagicNumbers: The one number here is the count of mock spellings the plugin must refuse. Naming it would put the expected result on a different line from the assertion.
